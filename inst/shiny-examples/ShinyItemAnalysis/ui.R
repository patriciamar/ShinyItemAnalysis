...
total score. Their size is determined by count of respondents who answered item correctly.'),
         ...
         ylab = "Factor score")')),
                ...
                tabPanel('Summary',
                  ...
                  img(src = 'fig_NLR_nonuniformDIF.png', width = 380, align = "right"),
                  br(),
                  br()
                  ),
                # TOTAL SCORES
              ...
              p.adjust.method = "BH")'),
                ...
                tabPanel("IRT Lord",
                  tabsetPanel(
                    tabPanel('Summary',
                             ...
                             selectInput("correction_method_IRT_LordSummary", "Correction method",
                                         c("BH" = "BH",
                                           "Holm" = "holm",
                                           "Hochberg" = "hochberg",
                                           "Hommel" = "hommel",
               ...
               p.adjust.method = "BH")'),
                  ...
                  tabPanel('Items',
                           ...
                           selectInput("correction_method_IRT_LordItems", "Correction method",
                                       c("BH" = "BH",
                                         "Holm" = "holm",
                                         "Hochberg" = "hochberg",
                                         "Hommel" = "hommel",
                ...
                tabPanel("IRT Raju",
                         tabsetPanel(
                           tabPanel('Summary',
                                    ...
                                    selectInput("correction_method_IRT_RajuSummary", "Correction method",
                                                c("BH" = "BH",
                                                  "Holm" = "holm",
                                                  "Hochberg" = "hochberg",
                                                  "Hommel" = "hommel",
               ...
               p.adjust.method = "BH")'),
                           ...
                           tabPanel('Items',
                                    ...
                                    selectInput("correction_method_IRT_RajuItems", "Correction method",
                                                c("BH" = "BH",
                                                  "Holm" = "holm",
                                                  "Hochberg" = "hochberg",
                                                  "Hommel" = "hommel",
