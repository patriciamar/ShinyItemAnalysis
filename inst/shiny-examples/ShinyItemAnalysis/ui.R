                        ...
                        tabPanel("Polytomous models",
                                 tabsetPanel(
                                   ...
                                   tabPanel('Nominal response model',
                                            ...
                                            ('$$\\mathrm{E}\\left(Y \\vert \\theta, \\alpha_0, \\dots, \\alpha_K, \\delta_0, \\dots, \\delta_K\\right) = \\sum_{k = 0}^K k\\pi_k$$'),
                                            h4("Plots"),
                                            splitLayout(cellWidths = c("50%", "50%"),
                                                        plotlyOutput('irt_training_nrm_plot'),
                                                        plotlyOutput('irt_training_nrm_plot_expected')),
                                            splitLayout(cellWidths = c("50%", "50%"),
                                                        downloadButton("DB_irt_training_nrm_plot", label = "Download figure"),
                                                        downloadButton("DB_irt_training_nrm_plot_expected", label = "Download figure")),
                                            h4("Selected R code"),
