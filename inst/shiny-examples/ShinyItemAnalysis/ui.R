             ...
             navbarMenu("Summary",
                        ...
                        tabPanel("Standard Scores",
                                 ...
                                 p(strong('Total Score'), 'also known as raw score is a total number of correct
                                   ...
                                   is equal to 20 and individual score is 12 than success rate is 12/20 = 0.6, i.e. 60%.', br(),
                                   ...
                                   standard deviation than Z-score = (X - M) / SD. ', br(),
                                   strong('T-score'), 'is transformed Z-score with a mean of 50 and standard deviation
                                   of 10. If Z is Z-score than T-score = (Z * 10) + 50. '),
                                 h4("Table by Score"),
