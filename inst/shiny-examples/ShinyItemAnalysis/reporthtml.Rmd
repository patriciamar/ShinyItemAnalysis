...
```{r wright-map, echo = FALSE, results = "hide", fig.height = 5.5, fig.width = 10, fig.align = 'center'}
...
```{r irt-0, echo = FALSE, results = "hide", fig.height = 4, fig.align = 'center'}
if (params$irt_type != "none") {
  params$irt
}
```

```{r irt-1, echo = FALSE, results = "hide", fig.height = 4, fig.align = 'center'}
if (params$irt_type != "none") {
  params$irtiic
}
```

```{r irt-2, echo = FALSE, fig.height = 4, fig.align = 'center'}
if (params$irt_type != "none") {
  params$irttif
}
```
...
```{r irt-3, echo = FALSE, fig.height = 4, fig.align = 'center'}
if (params$irt_type != "none") {
