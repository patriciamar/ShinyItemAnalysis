...
if(params$DDplotNumGroups == 3 & params$DDplotRange1 == 1 & params$DDplotRange2 == 3){
  ...
  kable(table, digits = c(0, 2, 2, 2, 2, 2), align = 'c')
...
if (params$histCheck) {
  if(params$isGroupPresent){
    kable(params$resultsgroup, digits = c(0, 0, 3, 0, 3, 3, 3), align = c('l', rep('c', 6)))
  }
}
```
...
if (params$deltaplotCheck) {
  if(params$isGroupPresent){
    ...
    kable(tab, digits = c(0, 3, 3, 3, 3, 3), align = c('l', rep('c', 5)))
  }
}
```
