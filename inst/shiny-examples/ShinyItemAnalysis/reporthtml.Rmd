...
`r if(params$deltaplotCheck){if(params$isGroupPresent){res <- params$DIF_deltaplot_text; paste("Detection threshold is ", round(res$thr, 2), ". ", ifelse(res$DIFitems == "no DIF item detected", "**No DIF item was detected.**  ", paste("**Items were detected as DIF: ", res$DIFitems, ". **  ", sep = "")), sep = "")}}`
