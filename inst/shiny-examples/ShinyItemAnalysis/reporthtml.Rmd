...
`r if(params$isGroupPresent & params$logregCheck) {res <- params$DIF_logistic_print; paste("The detection threshold is ", round(res$thr, 2), ". ", ifelse(any(res$DIFitems == "No DIF item detected"), "**No DIF item was detected. **  ", paste("**Items detected as DIF: ", paste(params$itemNames[res$DIFitems], collapse = ", "), ". **  ", sep = "")), sep = "")}`
