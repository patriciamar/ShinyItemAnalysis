  ...
  tabPanel("Reports",
           ...
           fluidRow(
             ...
             conditionalPanel(condition = "input.customizeCheck",
                              ...
                              conditionalPanel(condition = "input.MHCheck",
                                               column(2,
                                                      p(strong("Mantel-Haenszel test settings")),
                                                      selectInput(inputId = "correction_method_MH_report",
                                                                  ...
                                                                  selected = "none",
                                                                  width = "85%"),
                                                      checkboxInput(inputId = 'puri_MH_report',
                                                                    label = 'Item purification',
                                                                    value = FALSE)
                                               )
                              ),
