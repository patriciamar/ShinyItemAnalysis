uiAbout <- tabPanel("",
                  ...
                  fluidRow(
                    ...
                    column(6, h4("Versions"),
                           p("Current",
                             ...
                             a("GitHub", href = "https://github.com/patriciamar/ShinyItemAnalysis", target = "_blank"), "is 1.3.0-11.",
                             br(),
                  ...
                  fluidRow(
                    ...
                    column(1, align = "center",
                           ...
                           HTML("<figcaption><a href='http://www.cs.cas.cz/drabinova/' target='_blank'>Adela<br>Hladka</a></figcaption>")),
                    column(1, align = "center",
