...
uiTraditionalAnalysis <- navbarMenu('Item analysis',
                                    ...
                                    tabPanel("Traditional item analysis",
                                             ...
                                             br(),
                                             fluidRow(column(2, selectInput(inputId = "DDplotDiscriminationDifficulty",
                                                                            label = "Difficulty type:",
                                                                            choices = c("Average scaled score" = "AVGSS",
                                                                                        "Average item score" = "AVGS"),
                                                                            selected = "AVGSS")),
                                                      column(2, selectInput(inputId = "DDplotDiscriminationSelect",
                                                      ...
                                                      conditionalPanel(condition = "input.DDplotDiscriminationSelect=='ULI'",
                                                                       column(2, sliderInput(inputId = 'DDplotNumGroupsSlider',
                                                                                             label = 'Number of groups:',
                                                                                             min = 2,
                                                                                             max = 5,
                                                                                             value = 3)),
                                                                       column(2, sliderInput(inputId = "DDplotRangeSlider",
                                                                                             ...
                                                                                             value = c(1, 3)))),
                                                      column(2,
                                                             div(style = "horizontal-align:left",
                                                                 checkboxInput(inputId = "DDplotThr_cb",
                                                                               label = "Show threshold",
                                                                               value = TRUE)),
                                                             conditionalPanel(condition = "input.DDplotThr_cb",
                                                                              fluidRow(
                                                                                div(style = "display: inline-block; vertical-align:center; padding-left:10pt", HTML("<b>Threshold:</b>")),
                                                                                div(style = "display: inline-block; vertical-align:center; width: 45%;",
                                                                                    numericInput(inputId = "DDplotThr",
                                                                                                 label = NULL,
                                                                                                 value = .2,
                                                                                                 min = 0,
                                                                                                 max = 1,
