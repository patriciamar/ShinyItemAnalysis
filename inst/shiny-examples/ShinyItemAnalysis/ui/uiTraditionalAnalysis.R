...
uiTraditionalAnalysis <- navbarMenu('Item analysis',
                                    ...
                                    tabPanel("Traditional item analysis",
                                             ...
                                             p("Displayed is difficulty (red) and discrimination (blue)
                                               ...
                                               items both estimates are equivalent and can be interpreted as percent of respondents who answered item correctly. ',
                                               br(),
                                               ...
                                               very easy or very difficult items. Discrimination can be customized (see also Martinkova,
                                               Stepanek et al., 2017) by changing number of groups and by changing which groups should be compared: '),
                                             fluidRow(column(3, selectInput(inputId = "DDplotDiscriminationDifficulty",
                                                                            label = "Difficulty type:",
                                                                            choices = c("Average scaled score" = "AVGSS",
                                                                                        "Average item score" = "AVGS"),
                                                                            selected = "AVGSS")),
                                                      column(3, selectInput(inputId = "DDplotDiscriminationSelect",
                                                      ...
                                                      conditionalPanel(condition = "input.DDplotDiscriminationSelect=='ULI'",
                                                                       column(3, sliderInput(inputId = 'DDplotNumGroupsSlider',
                                                                                             label = 'Number of groups:',
                                                                                             min = 1,
                                                                                             max = 5,
                                                                                             value = 3)),
                                                                       column(3, sliderInput(inputId = "DDplotRangeSlider",
