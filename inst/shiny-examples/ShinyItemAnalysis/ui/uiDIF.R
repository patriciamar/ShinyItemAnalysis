...
uiDIF <-
  navbarMenu(
    ...
    # * TOTAL SCORES ####
    tabPanel(
      "Total scores, matching variables",
      h3("Total scores and other matching variables"),
      p(
        "DIF analysis may come to a different conclusion than test of group differences in total scores.
      ...
      HTML(paste0(
        "Notes: Test for difference in ", textOutput("DIF_total_matching_title4", inline = T), " between
    ...
    tabPanel(
      ...
      tabsetPanel(
        ...
        tabPanel(
          ...
          h4("Method specification"),
          p(
            "Here you can select ", strong("correction method"), " for multiple comparison, and/or ",
    ...
    tabPanel(
      ...
      tabsetPanel(
        ...
        tabPanel(
          ...
          h4("Method specification"),
          p(
            "Here you can choose what", strong("type"), " of DIF to be tested. You can also select ", strong("correction method"), " for multiple comparison or", strong("item purification."),
    ...
    tabPanel(
      ...
      tabsetPanel(
        ...
        tabPanel(
          ...
          p(
            "Finally, you may change the ", strong("DIF matching variable."), " While matching on standardized total score is typical, upload
    ...
    tabPanel(
      ...
      tabsetPanel(
        ...
        tabPanel(
          ...
          h4("Method specification"),
          p(
            "Here you can change ", strong("DIF matching variable"), " and choose ", strong("type"), " of DIF to be tested. You can also select ",
          ...
          h4("Equation"),
          p(
            "The probability that person ", strong("\\(p\\)"), " with DIF matching variable (e.g., standardized total score) ",
          ...
          conditionalPanel(
            "input.DIF_cum_purification_summary == 1",
    ...
    tabPanel(
      ...
      tabsetPanel(
        ...
        tabPanel(
          ...
          conditionalPanel(
            "input.DIF_adj_purification_summary == 1",
    ...
    tabPanel(
      ...
      tabsetPanel(
        ...
        tabPanel(
          ...
          h4("Method specification"),
          p(
            "Here you can change ", strong("DFF matching variable"), " and choose ", strong("type"), " of DDF to be tested. You can also select ", strong("correction method"),
          ...
          conditionalPanel(
            "input.DDF_multi_purification_summary == 1",
        ...
        tabPanel("Items",
          ...
          h4("Method specification"),
          p(
            "Here you can change ", strong("DDF matching variable"), " and choose ", strong("type"), " of DDF to be tested. You can also select ", strong("correction method"),
