...
uiDIRT <- tabPanel("Dichotomous models",
                 ...
                 ('$$\\mathrm{I}\\left(\\theta \\vert a, b, c, d \\right) = \\frac{a^2 \\cdot \\left(\\mathrm{P}\\left(\\theta \\vert a, b, c, d \\right) - c\\right)^2 \\cdot \\left(d - \\mathrm{P}\\left(\\theta \\vert a, b, c, d \\right)\\right)^2}{\\mathrm{P}\\left(\\theta \\vert a, b, c, d \\right) \\cdot \\left(1 - \\mathrm{P}\\left(\\theta \\vert a, b, c, d \\right)\\right) \\left(d - c\\right)^2} $$'),
