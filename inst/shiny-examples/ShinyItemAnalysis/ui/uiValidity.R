uiValidity <-
  navbarMenu("Validity",
             ...
             tabPanel("Correlation structure",
                      ...
                      fluidRow(column(3, selectInput(inputId = "type_of_corr",
                                                     label    = "Choose correlation",
                                                     choices  = c("Pearson"    = "pearson",
                                                                  "Spearman"   = "spearman",
                                                                  "Polychoric" = "polychoric"),
                                                     selected = 'polychoric')),
                               column(3, selectInput(inputId = 'corr_plot_clustmethod',
                                                     ...
                                                     choices = list("None" = "none",
                                                                    ...
                                                                    "Centroid" = "centroid"),
                                                     selected = "none")),
                               column(3, numericInput(inputId = 'corr_plot_clust',
                                                      label = 'Number of clusters',
                                                      value = 1,
                                                      min = 1,
                                                      max = 1)),
                               column(3,
                                      tags$style(HTML('#show_corr { margin-top: 25px }')),
