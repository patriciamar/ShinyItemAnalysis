uiValidity <-
  navbarMenu("Validity",
             ...
             tabPanel("Correlation structure",
                      ...
                      fluidRow(column(2, selectInput(inputId = "type_of_corr",
                                                     label    = "Choose correlation",
                                                     choices  = c("Pearson"    = "pearson",
                                                                  "Spearman"   = "spearman",
                                                                  "Polychoric" = "polychoric"),
                                                     selected = 'polychoric')),
                               column(2, selectInput(inputId = 'corr_plot_clustmethod',
                                                     ...
                                                     choices = list("None" = "none",
                                                                    ...
                                                                    "Centroid" = "centroid"),
                                                     selected = "none")),
                               column(2, numericInput(inputId = 'corr_plot_clust',
                                                      label = 'Number of clusters',
                                                      value = 0,
                                                      min = 0,
                                                      max = 1)),
                               column(2, br(),
                                      checkboxInput("show_corr", label = "Display correlation values",
                                                    value = FALSE)
                                      ),
                               column(2,
                                      numericInput("corr_plot_labs_size", label = "Values display size",
                      ...
                      br(),
                      conditionalPanel(condition = "input.corr_plot_clustmethod != 'none' & input.corr_plot_clust != 0",
                                       h4("Dendrogram"),
