...
`r if (params$irt_type != "none") {"Item Response Theory (IRT) models are mixed-effect regression models in which student ability $\\theta$ is assumed to be a random effect and is estimated together with item paramters. Ability $\\theta$ is often assumed to follow normal distibution."}`
