...
`r if(params$isGroupPresent & params$histCheck) {paste("For selected cut-score", params$cutScore, "the blue part of histograms shows respondents with a total score above the cut-score, the grey column shows respondents with a  total score equal to the cut-score and the red part of histograms shows respondents below the cut-score.")}`
