...
```{r irt-0, echo = FALSE, results = "hide", fig.height = 4, fig.width = 11, dpi = 300}
if (params$irt_type != "none") {
...
```{r irt-1, echo = FALSE, results = "hide", fig.height = 4, fig.width = 11, dpi = 300}
if (params$irt_type != "none") {
...
```{r irt-2, echo = FALSE, results = "hide", fig.height = 4, fig.width = 11, dpi = 300}
if (params$irt_type != "none") {
  params$irttif
}
```
