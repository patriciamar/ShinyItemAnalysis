...
`r if (any(params$corr_plot != "") & params$corr_plot_numclust > 1) {paste("Polychoric correlation heat map is reorder using hierarchical clustering with Ward's minimum variance method which aims at finding compact clusters. Number of", params$corr_plot_numclust, "clusters is considered. ")}`
...
if (any(params$corr_plot != "")) {
  ...
  if (numclust == 1){
    ...
    corrplot(params$corr_plot, tl.cex = 0.7,
             order = "hclust", hclust.method = "ward.D", addrect = numclust)
  }
}
```
