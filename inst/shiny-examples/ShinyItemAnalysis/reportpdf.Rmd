...
params$histogram_totalscores + ggtitle('Histogram of total scores') + theme(text = element_text(size = 14), plot.title = element_text(face = "bold"))
```
...
if(params$isCriterionPresent & params$validity_check){
  ...
  txt5 <- paste("Results:", expression(rho), "=", rho, "(p-value ", p.val ,").") 
  txt6 <- paste("Interpretation: The p-value is", txt1, "0.05, thus we", txt2, "null hypothesis;", txt3)
...
params$difPlot + ggtitle('Difficulty/Discrimination plot') + theme(text = element_text(size = 14), plot.title = element_text(face = "bold"))
```
...
if (params$irt_type != "none") {
  params$irtfactor + ggtitle('Scatterplot of factor scores and standardized total scores') + theme(text = element_text(size = 14), plot.title = element_text(face = "bold"))
}
```
...
if (params$histCheck) {
  if(params$isGroupPresent){
    g1 = params$histbyscoregroup0 + theme(text = element_text(size = 14), plot.title = element_text(face = "bold"))
    g2 = params$histbyscoregroup1 + theme(text = element_text(size = 14), plot.title = element_text(face = "bold"))
