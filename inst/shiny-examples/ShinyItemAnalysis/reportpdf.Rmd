...
if(params$isCriterionPresent & params$validity_check){
  ...
  txt4 <- paste("A test for association between the total score and the criterion variable is based on Spearman`s ", expression(rho), 
...
`r if (params$DDplotDiscType == "ULI") {"Difficulty (red) of items is estimated as a percentage of the respondents who answered correctly to that item. Discrimination (blue) is described by the difference of the percent correct in the upper and lower third of respondents (Upper-Lower Index, ULI). By a rule of thumb, it should not be lower than 0.2 (borderline in the plot), except for very easy or very difficult items."}`
