...
`r if (any(params$corr_plot != "")) {if (params$corr_type == "spearman") {"Correlation heat map is a correlation plot which displays Polychoric correlations of items. Spearman's rank correlation coefficient describes strength and direction of monotonic relationship between random variables X and Y, i.e. dependence between the rankings of two variables."}}`
