...
```{r corr-plot, echo = FALSE, fig.height = 4.5, fig.width = 9, dpi = 300}
...
`r if(params$deltaplotCheck){if(params$isGroupPresent){res <- params$DP_text_normal; paste("Detection threshold is ", round(res$thr, 2), ". ", ifelse(res$DIFitems == "no DIF item detected", "\\textbf{No DIF item detected.}  ", paste("\\textbf{Items detected as DIF: ", res$DIFitems, ".}  ", sep = "")), sep = "")}}`
