...
header-includes:
   ...
   - \hyphenation{Shi-ny-Item-A-na-ly-sis}
includes:
...
\bibitem{martinkova2019}
  Martinkov\'a P., Drabinov\'a A., Leder O., \& Houdek J.
  (2019)
  ShinyItemAnalysis: Test and item ana\-ly\-sis via shiny. R package version 1.3.0.
...
if(params$DDplotNumGroups == 3 & params$DDplotRange1 == 1 & params$DDplotRange2 == 3){
  ...
  table = data.frame(table[, 1], tab[, -7])
  colnames(table) = c("Item", "Diff.", "SD", "ULI", "RIT", "RIR", "Alpha Drop")
...
`r if(params$deltaplotCheck){if(params$isGroupPresent){res <- params$DIF_deltaplot_text; paste("Detection threshold is ", round(res$thr[length(res$thr)], 2), ". ", ifelse(res$DIFitems == "no DIF item detected", "\\textbf{No DIF item was detected.}  ", paste("\\textbf{Items were detected as DIF: ", res$DIFitems, ".}  ", sep = "")), sep = "")}}`
