...
The `dataMedicaltest` dataset consists of the responses of 2,392
...
contains 100 items, possible answers were A, B, C, D, while any
combination of these can be correct.
...
A `dataMedicaltest` is a `data.frame` consisting of 2,392 observations
on the following 102 variables.
