...
`HCItest` dataset consists of the responses of 651 students (405 males,
246 females) to Homeostasis Concept Inventory (HCI) multiple-choice
test. It containts 20 items, vector of gender membership and
...
`HCItest` is a `data.frame` consisting of 651 observations on the 22
variables.
