...
The `dataMedicalgraded` dataset consists of the responses of 2,392
...
points were set if all correct answers and none of incorrect answers
were selected.
...
A `dataMedicalgraded` is a `data.frame` consisting of 2,392 observations
