...
#'
#' @description `LearningToLearn` is a real longitudinal dataset used in Martinkova et al (2020) study,
...
#' (variable `track_01` or `track`) is available, with 391 students attending basic school (BS) and 391 pursuing
...
#'
#' @references
#' Martinkova, P., Hladka, A., & Potuznikova, E. (2020).
#' Is academic tracking related to gains in learning competence?
#' Using propensity score matching and differential item change functioning analysis for better understanding of tracking implications.
#' \emph{Learning and Instruction}, \emph{66}, 101286. \url{https://doi.org/10.1016/j.learninstruc.2019.101286}
#'
#' @keywords datasets
#'
