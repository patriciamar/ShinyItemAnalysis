...
#'
#' @author Cestmir Stuka
#' \cr First Faculty of Medicine, Charles University \cr
#'
#' Martin Vejrazka
#' \cr First Faculty of Medicine, Charles University \cr
#'
#' Patricia Martinkova
#' \cr Institute of Computer Science of the Czech Academy of Sciences
#' \cr \email{martinkova@@cs.cas.cz} \cr
#'
#' @references Stuka, C. Vejrazka, M., Martinkova, P. Komenda, M. & Stepanek, L.
#' (2016). The Use of Test and Item Analysis for Improvement of Tests. Workshop
